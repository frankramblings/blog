...
<div class="textbook-pages" style="max-width:720px;margin:2rem auto;">
  <img src="{{site.url}}{{site.baseurl}}/assets/images/2026/03/chapter14_page1.jpg" alt="Chapter 14, page 1: The American Unraveling in Global Context, 1945 to the Trump Era" width="100%" loading="eager" style="display:block;margin-bottom:2px;">
  <img src="{{site.url}}{{site.baseurl}}/assets/images/2026/03/chapter14_page2.jpg" alt="Chapter 14, page 2" width="100%" loading="lazy" style="display:block;margin-bottom:2px;">
  <img src="{{site.url}}{{site.baseurl}}/assets/images/2026/03/chapter14_page3.jpg" alt="Chapter 14, page 3" width="100%" loading="lazy" style="display:block;margin-bottom:2px;">
  <img src="{{site.url}}{{site.baseurl}}/assets/images/2026/03/chapter14_page4.jpg" alt="Chapter 14, page 4" width="100%" loading="lazy" style="display:block;margin-bottom:2px;">
  <img src="{{site.url}}{{site.baseurl}}/assets/images/2026/03/chapter14_page5.jpg" alt="Chapter 14, page 5" width="100%" loading="lazy" style="display:block;">
</div>
